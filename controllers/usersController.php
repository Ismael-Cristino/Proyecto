...
class UsersController
{
    ...
    // sustituimos crear por este método
    public function crear(array $arrayUser): void
    {
        ...
        if (!is_valid_usuario($arrayUser["usuario"])) {
            $error = true;
            $errores["usuario"][] = "El nombre de usuario tiene un formato incorrecto";
        }
    ...
    // sustituimos editar por este editar
