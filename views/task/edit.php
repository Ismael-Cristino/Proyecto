...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3">Editar Tarea <?= $task->name ?> con Id: <?= $id ?> </h1>
    </div>
    <div id="contenido">
        ...
        ?>
            <form action="index.php?accion=guardar&tabla=task&evento=modificar" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="<?= $task->name ?? "" ?>" aria-describedby="name" placeholder="Introduce Nombre Tarea">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="deadline" name="deadline" value="<?= $task->deadline ??  date('Y-m-d') ?>">
