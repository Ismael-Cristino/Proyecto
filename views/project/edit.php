...
if ($project == null) {
    ...
    $visibilidad = "visibility";
    $mensaje = "Proyecto {$project->name} con id {$id} Modificado con éxito";
    if (isset($_REQUEST["error"])) {
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3">Editar Proyecto <?= $project->name ?> con Id: <?= $id ?> </h1>
    </div>
    <div id="contenido">
        ...
        ?>
            <form action="index.php?tabla=project&accion=guardar&evento=modificar" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  class="form-control" id="name" name="name" value="<?= $project->name ?>" aria-describedby="name" placeholder="Introduce Nombre Proyecto">
