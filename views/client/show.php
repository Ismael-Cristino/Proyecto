    ...
    <div id="contenido">
        <div class="card"  style="width: 18rem;">
            <div >
                ...
                <p class="card-text">
                    idFiscal: <?= $client->idFiscal ?> <br>
                    Nombre: <?= $client->contact_name ?> <br>
                    Email: <?= $client->contact_email ?> <br>
                    Telefono: <?= $client->contact_phone_number ?> <br>
                    Compañia: <?= $client->company_name ?> <br>
                    Direccion: <?= $client->company_address ?><br>
                    T. Compañia: <?= $client->company_phone_number ?><br>
                </p>
